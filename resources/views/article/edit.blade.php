            ...
            <div class="col-md-8">
                <form method="POST" action="{{route('article.update', $article)}}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <img src="{{ Storage::url($article->image) }}" alt="{{ $article->title }}" class="img-fluid p-2 border">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="tags" class="form-control" id="tags" value="{{ $article->tags->implode('name', ', ') }}" placeholder="Inserisci i tag separati da una virgola">
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                        <button type="submit" class="btn btn-outline-secondary me-3">Modifica articolo</button>
