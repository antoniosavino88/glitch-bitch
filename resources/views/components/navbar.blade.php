{{-- <nav class="navbar navbar-expand-lg bg-2" data-bs-theme="dark">
    <div class="container-fluid">
        <a class="navbar-brand logo-nav transition mx-2" href="{{ route('homepage') }}"><img src="/media/logo-nav2.png"
                alt=""></a>
            ...
            <ul class="navbar-nav mb-2 mb-lg-0 me-lg-3">
                ...
                @auth
                    <li class="nav-item dropdown position-relative">
                        ...
                        <ul class="dropdown-menu drop-custom dropdown-menu-end text-center">
                            @if (Auth::user()->is_admin)
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('admin.dashboard') }}">Dashboard Admin</a>
                                </li>
